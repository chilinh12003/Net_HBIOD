...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Content" runat="server">
    ...
    <div class='tabtracuusddv'>
        <ul>
            <li><a href='Ad_HistoryCharge.aspx' class='wrapping-link-inline'>Lịch sử trừ cước</a></li>
            <li><a href='Ad_HistoryUsing.aspx' class='wrapping-link-inline' >Lịch sử sử dụng</a></li>
            <li><a  href='Ad_HistoryMOMT.aspx' class='wrapping-link-inline select'>Lịch sử MO/MT</a></li>
        </ul>
    </div>
