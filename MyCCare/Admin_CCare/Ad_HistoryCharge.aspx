...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_Content" runat="server">
    ...
    <div class='tabtracuusddv'>
        <ul>
            <li><a class=" wrapping-link-inline select" href='Ad_HistoryCharge.aspx'>Lịch sử trừ cước</a></li>
            <li><a class=" wrapping-link-inline" href='Ad_HistoryUsing.aspx' >Lịch sử sử dụng</a></li>
            <li><a class=" wrapping-link-inline" href='Ad_HistoryMOMT.aspx'>Lịch sử MO/MT</a></li>
        </ul>
    </div>
