...
namespace MyHBIOD.Service
{
    public class ChargeLog
    {
        ...
        /// </summary>
        /// <param name="Type">
        /// <para>Type = 11: Thông tin gia hạn (Para_1 = PID, Para_2 = ChargeTypeID,Para_3 = ChargeStatusID, Para_4 = BeginDate, Para_5 = EndDate</para>
        /// <para>Type = 18: Lấy tổng tiền (Para_1 = PID, Para_2 = ChargeTypeID,Para_3 = ChargeStatusID, Para_4 = BeginDate, Para_5 = EndDate</para>
        /// </param>
        ...
        public DataTable Select(int Type, string Para_1, string Para_2, string Para_3, string Para_4, string Para_5)
        {
            try
            {
                ...
                DataTable mTable = mGet.GetDataTable("Sp_ChargeLog_Select", mPara, mValue);
        ...
        /// </summary>
        /// <param name="Type">
        /// <para>Type = 9: Lay ChargeLog (Para_1 = PID, Para_2 = ChargeTypeID,Para_3 = ChargeStatusID, Para_4 = ChannelTypeID, Para_5 = BeginDate, Para_6 = EndDate</para>
        /// <para>Type = 12: Lấy tần suất sử dụng (Para_1 = PID, Para_2 = ChargeTypeID, Para_3 = BeginDate, Para_4 = EndDate,Para_5 = Begin_TanSuat, Para_6 = End_TanSuat</para>
        /// <para>Type = 17: Lấy tổng tiền (Para_1 = PID, Para_2 = ChargeTypeID,Para_3 = ChargeStatusID, Para_4 = ChannelTypeID, Para_5 = BeginDate, Para_6 = EndDate</para>
        /// </param>
        /// <param name="Para_1"></param>
        /// <param name="Para_2"></param>
        /// <param name="Para_3"></param>
        ...
        /// <para>Type = 10: Lấy tổng số thuê bao sử dụng (Para_1 = PID, Para_2 = ChargeTypeID, Para_3 = BeginDate, Para_4 = EndDate</para>
        /// <para>Type = 13: Thông tin gia hạn (Para_1 = PID, Para_2 = ChargeTypeID, Para_3 = BeginDate, Para_4 = EndDate</para>
        /// </param>
        /// <param name="Para_1"></param>
        /// <param name="Para_2"></param>
        /// <param name="Para_3"></param>
        ...
        /// <para>Type = 15: Lấy ngày nhỏ nhất (Para_1 = PID, Para_2 = BeginDate)</para>
        /// </param>
        /// <param name="Para_1"></param>
        /// <param name="Para_2"></param>
        /// <returns></returns>
        ...
        /// <para>Type = 16: Lấy ngày lớn nhất (Para_1 = PID)</para>
        /// </param>
        /// <param name="Para_1"></param>
        /// <param name="Para_2"></param>
        /// <returns></returns>
        ...
        /// <para>SelectType = 3: Lấy lịch sử mua nội dung</para>
        /// <para>SelectType = 4: Lấy lịch sử gia hạn & mua noi dung</para>
        /// </param>
        /// <returns></returns>
