...
<asp:Content ID="Content4" ContentPlaceHolderID="cph_Search" runat="server">
   <label>
    ...
    <div runat="server" id="div_Charge" style="font-size: 12px;" visible="false">
        ...
        <fieldset style="width: 300px; margin-right: 30px;float: left; margin-top: 30px;">
            <legend>Tỷ lệ Charge mua nội dung</legend>
            <p>
                <label>
                    Tỷ lệ:</label><label class="DanhDau"><%=Percent_Charge_BuyContent.ToString(MyUtility.MyConfig.DoubleFormat)%>%</label>
            </p>
            <p>
                <label>
                    Tổng Charge:</label><label class="DanhDau"><%=TotalCharge_BuyContent.ToString(MyUtility.MyConfig.IntFormat)%></label>
            </p>
            <p>
                <label>
                    Tổng Charge thành công:</label><label class="DanhDau"><%=TotalCharge_BuyContent_Success.ToString(MyUtility.MyConfig.IntFormat)%></label>
            </p>
            <p><i>Chú ý: Tổng Charge là: Số lần gọi lệnh charge (1 thuê bao có thể gọi nhiều lần charge/1 ngày)</i></p>
        </fieldset>
         <fieldset style="width: 300px; margin-right: 30px;float: left; margin-top: 30px;">
