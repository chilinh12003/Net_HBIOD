...
{
    public partial class Ad_KPI_Sub : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.KPI_Sub, Member.MemberGroupID());
                }
                else
                {
        ...
        int Admin_Paging1_GetTotalPage_Callback_Change()
        {
            try
            {
               ...
               return mRP_Sub.TotalRow(SearchType, BeginDate, EndDate);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mRP_Sub.Search(SearchType, Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow,  BeginDate, EndDate, SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
