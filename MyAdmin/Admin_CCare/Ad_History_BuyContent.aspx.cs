...
{
    public partial class Ad_History_BuyContent : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.History_BuyContent, Member.MemberGroupID());
                }
                else
                {
