...
{
    public partial class Ad_History_Renew : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.History_Renew, Member.MemberGroupID());
                }
                else
                {
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                DataTable mTable = mChargeLog.Search_SelectType(SearchType, Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow, SearchContent, PID, 0, 0, 0, BeginDate, EndDate, 2, SortBy);
