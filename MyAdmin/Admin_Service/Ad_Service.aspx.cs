    ...
    public partial class Ad_Service : System.Web.UI.Page
    {
        ...
        int Admin_Paging1_GetTotalPage_Callback_Change()
        {
            try
            {
                ...
                return mService.TotalRow(SearchType, str_SearchContent, IsActive);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        DataTable Admin_Paging1_GetData_Callback_Change()
        {
            try
            {
                ...
                return mService.Search(SearchType, Admin_Paging1.mPaging.BeginRow, Admin_Paging1.mPaging.EndRow, str_SearchContent, IsActive, SortBy);
            }
            catch (Exception ex)
            {
                throw ex;
